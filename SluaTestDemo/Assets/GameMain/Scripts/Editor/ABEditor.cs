...
public class ABEditor
{
    ...
    /// 热更资源的根目录
    /// </summary>
    public static readonly string rootPath = Application.dataPath + "/GameAssets";
    ...
    /// AB包文件的输出路径
    /// </summary>
    public static readonly string abOutputPath = Application.streamingAssetsPath;
        ...
        foreach (string asset in asset2bundle.Keys)
        {
            ...
            if (assetList.Count > 0)
            {
                ...
                foreach (string oneAsset in assetList)
                {
                    ...
                    bool result = asset2bundle.TryGetValue(oneAsset, out bundle);
    ...
    private static void SaveModuleABConfig(string moduleName)
    {
        ...
        foreach (var item in asset2bundle)
        {
            ...
            bool result = asset2Dependencies.TryGetValue(item.Key, out dependencies);
